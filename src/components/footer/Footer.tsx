...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="py-8 man-container">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          {/* Brand and Social Links */}
          <div className="w-1/2 md:w-1/2 lg:w-1/4 mb-6">
            <h2 className="text-[23px] md:text-4xl lg:text-3xl font-bold mb-4">
              EquiTrain
            </h2>
          ...
          {/* Services Section */}
          <div className="w-1/2 md:w-1/2 lg:w-1/4 mb-6">
            <h6 className="text-[15px] md:text-3xl lg:text-xl font-semibold mb-4">
              {t("footer.sections.services.title")}
            </h6>
            <ul>
              <li className="mb-1 hover:text-blue-600 transition">
                <a href="#" className="text-[15px] md:text-xl lg:text-lg">
              ...
              <li className="mb-1 hover:text-blue-600 transition">
                <a href="#" className="text-x[15px] md:text-xl lg:text-lg">
          ...
          <div className="w-1/2 md:w-1/2 lg:w-1/4 mb-6 md:mt-1">
            <h6 className="text-[15px] md:text-lg lg:text-xl font-semibold mb-4">
          ...
          <div className="w-1/2 md:w-1/2 lg:w-1/4">
            ...
            <p className="mb-1 text-[15px] md:text-xl lg:text-lg">
